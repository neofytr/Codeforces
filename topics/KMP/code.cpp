...
//              of s.
//
// We define B(t) to be the set of all the borders of t, for any string non-empty string t
// We define b(t) to be set of all the border lengths of string t, for any non-empty string t
...
//                  =  { U^2(t), U^3(t), ..., U^(V(t))(t) }
//                                                 (Theorem 7: V(t) = V(U(t))+1 since t is non-empty (its length is i + 1 >= 1))
//
//     Therefore
...
// argument from Lesson 5 will use if this telescoping to bound total work.  QED.
//
// Theorem 11
